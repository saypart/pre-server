...
public class ContentControllerRestDocsTest {
    ...
    public void postContentTest() throws Exception{
        ...
        given(contentMapper.contentPostDtoToReply(Mockito.any(ContentPostDto.class))).willReturn(Mockito.mock(Content.class));
    ...
    public void patchContentTest() throws Exception {
        ...
        given(contentMapper.contentPatchDtoToReply(Mockito.any(ContentPatchDto.class))).willReturn(Mockito.mock(Content.class));
