...
public class ReplyControllerRestDocsTest {
    ...
    public void postReplyTest() throws Exception{
        ...
        given(replyMapper.replyToReplyResponseDto(Mockito.any(Reply.class))).willReturn(responseDto);
...
//
//        //when
//        ResultActions actions = mockMvc.perform(delete("/reply/{reply-id}",1));
//
//        //then
...
//                                ),
//                                responseFields(
//                                        fieldWithPath("data").type(JsonFieldType.STRING).description("요청 성공시 응답 메세지")
//                                ))
//                ).andReturn();
//    }
}
